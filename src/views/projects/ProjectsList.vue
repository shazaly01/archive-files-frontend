<template>
  <div class="p-6 space-y-6 min-h-screen">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h1 class="text-2xl font-bold text-text-primary">مستكشف اقسام الارشفة</h1>
        <p class="text-text-secondary mt-1">
          إدارة وتتبع مساحات العمل اقسام الارشفة الخاصة بك وبالشركة.
        </p>
      </div>
    ...
    >
      ...
      <h3 class="text-lg font-medium text-text-primary">لا توجد اقسام ارشفة</h3>
      <p class="text-text-muted mt-1 max-w-sm">
        لم يتم العثور على اقسام في هذا النطاق. جرب تغيير التبويب أو إنشاء قسم جديد.
      </p>
    </div>
...
// تعريف التبويبات
const tabs = [
  { label: 'اقسامى', value: 'mine' },
  { label: 'اقسام الارشف الحالى', value: 'department' },
